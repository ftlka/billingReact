    ...
    render() {
        return (
            <div className="Credit-Card">
                ...
                <form>
                    <input type="text" className="Card-Number Card-Form Form"
                        pattern="[0-9]{16}"
                        name="card-number" placeholder="Номер карты" required />
                    <input type="text" className="Card-Exp Card-Form Form"
                        pattern="(0[1-9]|1[0-2])\/(1[8-9]|2[0-9]|3[0-7])"
                        name="card-expiration" placeholder="ММ/ГГ" required />
                    <input type="text" className="Card-CVC Card-Form Form"
                        pattern="[0-9]{3}"
